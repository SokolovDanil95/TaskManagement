 ...
 */
@Entity
@Table(name = "stages_proect")
public class StagesProect implements Serializable {
    ...
    @NotNull
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "customer_stages_proect")
    @SequenceGenerator(sequenceName = "customer_stages_proect", allocationSize = 1, name = "customer_stages_proect")
    @Column(name = "id")
    private Long id;
    @Column(name = "daterun")
    ...
    public StagesProect(String name, String description, Date daterun, Date dateend,
        Statetask idsost, Integer readiness, Proect idproect) {
        this.name = name;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StagesProect)) {
            return false;
        }
        StagesProect other = (StagesProect) object;
    ...
    public String toString() {
        return "ru.oktpp.tuskoktpp.entity.StagesProect[ id=" + id + " ]";
    }
